...
const Player = ({
  ...
  return (
    <div>
      {showPlayer && (
        <div className=" backdrop-blur bg-opacity-75 player_container bg-black text-white p-4 rounded border border-gray-100 flex flex-col justify-between fixed bottom-0 left-0 w-full">
